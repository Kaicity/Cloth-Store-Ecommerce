package com.example.ctstart.configuration.sercurity.jwt;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request.requestMatchers("/api/v1/auth/**", "/api/v1/Food/findAll",
                                "/api/v1/Food/getAllProductByIds", "/api/v1/Customer/getCustomerByIdShare",
                                "/api/v1/Customer/login", "/api/v1/Customer/create").permitAll()
